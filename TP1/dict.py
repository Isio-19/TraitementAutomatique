...
createFile("train", createList("donnees_tp1/twitter-2013train-A.txt", wordDict))
createFile("dev", createList("donnees_tp1/twitter-2013dev-A.txt", wordDict))
createFile("test", createList("donnees_tp1/twitter-2013test-A.txt", wordDict))
